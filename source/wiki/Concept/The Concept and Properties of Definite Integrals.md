...
![[Pasted image 20251214180608.png]]
...
- 证明方法即：将积分符号拆分为求和极限符号后利用 [[limits - Some computational methodologies of the limits|极限计算技巧]] 来拆分
...
*关于为什么要探讨变上限积分的思考在这里*[[Definite integral, indefinite integral and differential]]
